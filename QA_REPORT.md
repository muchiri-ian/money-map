...
|---|---|---|---|
| FBS_PER_ATHLETE | $3,598 | $3,598 | ✅ present |
| JUCO_PER_ATHLETE | $60 | $60 | ✅ present |
| GAP_MULT | 60.4 | 60.4x | ✅ present |
| D1_SCHOOL_PCT | 21.7% | 21.7% | ✅ present |
| D1_DOLLAR_PCT | 87.1% | 87.1% | ✅ present |

*(Revised 2026-07-14 after the DIVISION_BUCKETS pipeline fix — old buggy-data values
$151 / 2.5x / 33.7% / 88.7% verified absent from the rebuilt bundle. Finding 3 chart
now renders all 7 divisions in PART E order including D3 and NAIA.)*
...
- [ ] Read SLOTS_REPORT.md; sanity-check GAP_MULT (60.4x) and D1_DOLLAR_PCT (87.1%)
  against `charts/draft_recruit_per_athlete.png` and `charts/draft_recruit_share.png`
  (drafts regenerated by the corrected pipeline run)
- [x] ~~Fix pipeline DIVISION_BUCKETS bug~~ — DONE 2026-07-14: pipeline fixed, rerun,
  CSVs replaced, D3 (396 schools) and NAIA (195 schools) restored
- [x] ~~Confirm YEARS_USED convention~~ — RESOLVED 2026-07-14: all survey-year displays
  now use academic-year ranges matching the EADA source filenames (2014-15, 2018-19,
  2024-25); chart titles derive the range programmatically from the CSV
